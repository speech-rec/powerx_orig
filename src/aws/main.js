...
var IsCustomDicionaryActive = false;
...
export const startRecording = (lastValue, sampleRate, inputSpecialty, language, transcribeType, keyWords_, callBack, getTemplateCallBack, IsCustomDicionaryActive, IsAutoPunctuationEnabled, IsDictaPhoneEnabled, PunctionKeyWords) => {
    log("started");
